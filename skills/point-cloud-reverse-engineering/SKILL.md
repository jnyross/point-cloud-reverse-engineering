...
- Diagnose why this CloudCompare or BricsCAD workflow failed, identify ineffective changes, and propose recovery from the last verified state.
...
- Never claim that an evaluated Blender mesh or a visually editable `.blend` satisfies an editable STEP/DWG deliverable.
- Never claim metric fit, clearance, or manufacturing readiness while units remain provisional or unknown.
